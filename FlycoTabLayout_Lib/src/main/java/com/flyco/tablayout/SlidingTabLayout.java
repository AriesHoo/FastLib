 ...
 * @Description: 1、2018年11月30日11:18:41 修改原作者 https://github.com/H07000223/FlycoTabLayout 选中粗体当初始化选中第一项不生效BUG
...
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mTextBold = TextBold.valueOf(ta.getInt(R.styleable.SlidingTabLayout_tl_textBold, TEXT_BOLD_NONE));
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        if (state instanceof Bundle) {
            ...
            if (mCurrentTab != 0 && mTabsContainer.getChildCount() > 0) {
                ...
                //原作者恢复状态时未将Fragment选中CurrentTab
