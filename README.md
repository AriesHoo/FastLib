...
[![](https://img.shields.io/badge/wiki-green.svg)](https://github.com/AriesHoo/FastLib/wiki)基于**FasbLib 2.2.12** 、**Android Studio 3.3.1**、**Gradle 4.10.1**版本编写,后期重大变更会同步更新。
